...
<!-- Mirrored from themezhub.net/workstock-2/work-stocks/browse-candidates-with-map.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 10 Jun 2021 17:43:15 GMT -->
<head>
    ...
    <body class="green-skin bg-light">
							...
							<div class="col-lg-12 col-md-12 col-sm-12">
								<div class="flt-result mb-3">
									...
									<div class="flt-change-layout">
										<a href="browse-candidates-with-map-grid.html"><i class="ti-layout-grid2"></i></a>
										<a href="browse-candidates-with-map.html" class="active"><i class="ti-view-list"></i></a>
									</div>
		...
		<script src="assets/js/candidates-map.js"></script>
