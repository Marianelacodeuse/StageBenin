							...
							<div class="row">
								<div class="col-md-12">
									...
									<div class="candidate-list-layout">
										<div class="cll-wrap">
											<div class="cll-thumb">
												<a href="resume-detail.html"><img src="assets/img/user-1.jpg" class="img-responsive img-circle" alt="" /></a>
											</div>
									...
									<div class="candidate-list-layout">
										<div class="cll-wrap">
											<div class="cll-thumb">
												<a href="resume-detail.html"><img src="assets/img/user-2.jpg" class="img-responsive img-circle" alt="" /></a>
											</div>
											<div class="cll-caption">
												<h4><a href="resume-detail.html">Shaurya Preet</a><span><i class="ti-briefcase"></i>Graphic Designer</span></h4>
												<ul>
													<li><i class="ti-location-pin text-danger"></i>208 Hampton, Newzeland</li>
													<li><i class="ti-time text-success"></i>Last Activity 10 days ago</li>
												</ul>
											</div>
										</div>
									...
									<div class="candidate-list-layout">
										<div class="cll-wrap">
											<div class="cll-thumb">
												<a href="resume-detail.html"><img src="assets/img/user-3.jpg" class="img-responsive img-circle" alt="" /></a>
											</div>
											<div class="cll-caption">
												<h4><a href="resume-detail.html">Robert C. Kelly</a><span><i class="ti-briefcase"></i>iPhone Developer</span></h4>
												<ul>
													<li><i class="ti-location-pin text-danger"></i>2283 Poco Mas Drive, Canada</li>
													<li><i class="ti-time text-success"></i>Last Activity 07 min ago</li>
												</ul>
											</div>
										</div>
									...
									<div class="candidate-list-layout">
										<div class="cll-wrap">
											<div class="cll-thumb">
												<a href="resume-detail.html"><img src="assets/img/user-4.jpg" class="img-responsive img-circle" alt="" /></a>
											</div>
											<div class="cll-caption">
												<h4><a href="resume-detail.html">Jazmin D. Starks</a><span><i class="ti-briefcase"></i>Magento Expert</span></h4>
												<ul>
													<li><i class="ti-location-pin text-danger"></i>2860 Park Boulevard, USA</li>
													<li><i class="ti-time text-success"></i>Last Activity 5 days ago</li>
												</ul>
											</div>
										</div>
									...
									<div class="candidate-list-layout">
										<div class="cll-wrap">
											<div class="cll-thumb">
												<a href="resume-detail.html"><img src="assets/img/user-5.jpg" class="img-responsive img-circle" alt="" /></a>
											</div>
											<div class="cll-caption">
												<h4><a href="resume-detail.html">Shirley C. Maggi</a><span><i class="ti-briefcase"></i>Wordpress Expert</span></h4>
												<ul>
									...
									<div class="candidate-list-layout">
										<div class="cll-wrap">
											<div class="cll-thumb">
												<a href="resume-detail.html"><img src="assets/img/user-6.jpg" class="img-responsive img-circle" alt="" /></a>
											</div>
											<div class="cll-caption">
												<h4><a href="resume-detail.html">Stewart C. Thomas</a><span><i class="ti-briefcase"></i>Stack Developer</span></h4>
												<ul>
													<li><i class="ti-location-pin text-danger"></i>4167 Ashwood Drive, UK</li>
													<li><i class="ti-time text-success"></i>Last Activity 02 min ago</li>
												</ul>
											</div>
										</div>
									...
									<div class="candidate-list-layout">
										<div class="cll-wrap">
											<div class="cll-thumb">
												<a href="resume-detail.html"><img src="assets/img/user-7.jpg" class="img-responsive img-circle" alt="" /></a>
											</div>
											<div class="cll-caption">
												<h4><a href="resume-detail.html">Michael S. Brown</a><span><i class="ti-briefcase"></i>PHP Developer</span></h4>
												<ul>
													<li><i class="ti-location-pin text-danger"></i>4012 Still Street, USA</li>
													<li><i class="ti-time text-success"></i>Last Activity 2 days ago</li>
												</ul>
											</div>
										</div>
									...
									<div class="candidate-list-layout">
										<div class="cll-wrap">
											<div class="cll-thumb">
												<a href="resume-detail.html"><img src="assets/img/user-8.jpg" class="img-responsive img-circle" alt="" /></a>
											</div>
											<div class="cll-caption">
												<h4><a href="resume-detail.html">Angela A. Vizcaino</a><span><i class="ti-briefcase"></i>UX Designer</span></h4>
												<ul>
													<li><i class="ti-location-pin text-danger"></i>3444 North Bend River, Canada</li>
													<li><i class="ti-time text-success"></i>Last Activity 07 min ago</li>
												</ul>
											</div>
										</div>
